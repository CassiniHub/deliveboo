<nav id="home-header" class="navbar navbar-expand-md navbar-light shadow-sm">
    <div class="container">
        <div class="home-header-container">
            ...
            <button class="navbar-toggler hamburger-position" type="button" data-toggle="dropdown" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="true" aria-label="{{ __('Toggle navigation') }}">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link navbar-button-login resp-disp-none" href="{{ route('login') }}" >{{ __('Login') }}  </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown-style resp-lg-disp-none" aria-labelledby="navbarDropdown">
                                ...
                                <a class="nav-link navbar-button-login resp-head-pop-mtop" href="{{ route('login') }}" >{{ __('Login') }} </a>

                                <a class="nav-link navbar-button-register" href="{{ route('register') }}">{{ __('Register') }}</a>
                            </div>
                        </li>

                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="nav-link navbar-button-register resp-disp-none" href="{{ route('register') }}">{{ __('Register') }}</a>
                            </li>
                        @endif
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown-style" aria-labelledby="navbarDropdown">
                                ...
                                <div class="dropdown-header-img-account">
                                    <div class="dropdown-header">
